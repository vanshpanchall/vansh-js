...
// console.log(10 - 2 / 4);  //division and then substraction
...
// console.log(20 / 4 - 2); //division first and then substraction
// console.log(2 + (3 * 4) / 2);  //multiplication > division > addition
// console.log(4 / 2 ** 2);  //exponential first and then divison\
...
// console.log(2 + 3 * 4 ** 2); //first exponential then multipication and then addition
// console.log((6 * (2 + 4)) / 3); //addition > multiplication (because main brackets)> division
// console.log((10 - 2) / 4); //substractiobn and then division
